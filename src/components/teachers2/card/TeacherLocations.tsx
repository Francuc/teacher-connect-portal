    ...
    <Section>
      ...
      <div className="grid grid-cols-2 gap-1.5 mt-1.5">
        {locations.map((location, index) => (
          <div 
            key={index}
            className="flex justify-between items-center p-1.5 rounded-lg bg-primary/5 hover:bg-primary/10 transition-all duration-200"
          >
            ...
            <Badge
              variant="outline"
              className="bg-primary text-white border-none flex items-center gap-0.5 text-xs py-0.5 px-1.5"
            >
