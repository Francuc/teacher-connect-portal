export const lb = {
    ...
    errorUploadingProfilePicture: "Feeler beim Eroplueden vum Profilbild",
    errorInvalidReference: "En ongëltege Referenzfeeler ass opgetrueden",
    errorDuplicateEntry: "En duebelen Aschreiwung gouf fonnt",
} as const;